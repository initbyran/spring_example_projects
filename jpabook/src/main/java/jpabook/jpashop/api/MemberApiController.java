...
public class MemberApiController {
    ...
    public Result membersV2() {
        ...
        // Object type으로 반환 ; 바로 json 배열 타입으로 나가면 유연성이 떨어짐
     ...
     * - Entity를 노출하지않고 API 스펙 관리 용이
     * - parameter를 어떤 값들을 받는지 쉽게 파악, validation 관리 용이
     */
    ...
    static class Result<T> {
        private int count; // 추가된 데이터 유연하게 대처 가능
        private T data;
    }
    @Data
    @AllArgsConstructor
